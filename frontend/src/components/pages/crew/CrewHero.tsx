...
export default function CrewHero({ CrewHeroBg, onUpdate }: CrewHeroProps) {
  ...
  const {
    ...
    handleImageChange,
    setIsSaving,
  } = useAdminEditable<CrewHeroEditData>({ image: CrewHeroBg });
    ...
    >
      ...
      {isAdmin && !isEditing && (
        <button
          ...
          aria-label="Edit crew hero section"
      ...
      >
        <div className="max-w-7xl mx-auto text-center flex flex-col items-center justify-center px-4 py-10 md:px-6 md:py-12 lg:px-12 lg:py-20">
          ...
          >
            People Who
            <br />
            <span className="text-[var(--color-accent)]">Make It Move</span>
          </motion.h1>
