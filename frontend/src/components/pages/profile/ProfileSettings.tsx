      ...
      <div className="md:bg-white/[0.03] md:backdrop-blur-2xl md:border md:border-white/10 md:rounded-[2.5rem] md:p-10 md:shadow-[0_8px_30px_rgb(0,0,0,0.5)]">
        ...
        <div className="mb-8 flex flex-col gap-2">
          ...
          <p className="text-white/50 text-sm sm:text-base font-body max-w-lg">
            Manage your secure credentials, update your email, or reset your
            password.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 sm:gap-6">
          ...
          <div className="md:bg-black/40 md:border md:border-white/5 rounded-3xl md:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-6 hover:border-white/10 transition-colors">
            <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] sm:text-[11px] font-accent tracking-[0.15em] text-white/50 uppercase mb-1">
                  Email Address
                </span>
                <span className="text-white font-body text-sm md:text-base sm:text-lg font-medium">
                  {userDetails.email}
                </span>
              </div>
            </div>
          ...
          <div className="md:bg-black/40 md:border md:border-white/5 rounded-3xl md:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-6 hover:border-white/10 transition-colors">
            <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-white font-body text-xl sm:text-2xl tracking-[0.2em] mt-0.5">
                  ••••••••
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col">
                ...
                {userDetails.googleConnected ? (
                  <span className="text-white font-body text-sm sm:text-base font-medium">
                    {userDetails.email}
                  </span>
                ) : (
                  <span className="text-white/50 font-body text-sm sm:text-base">
          ...
          <div className="md:bg-red-500/5 md:border md:border-red-500/20 rounded-3xl md:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-6 hover:border-red-500/40 hover:bg-red-500/10 transition-colors">
            <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] sm:text-[11px] font-accent tracking-[0.15em] text-red-500/70 uppercase mb-1">
                  Danger Zone
                </span>
                <span className="text-white font-body text-base sm:text-lg font-medium">
