...
export default function ProfileCover({ coverImageSrc, isOwner, hasImage, uploading, uploadType, onUploadClick, onRemoveClick }: ProfileCoverProps) {
  return (
          ...
          {hasImage && (
            <div className="absolute bottom-6 left-6 md:bottom-18 md:left-auto md:right-6 z-30">
              <button
                ...
                title="Remove Cover"
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="hover:scale-110 transition-transform"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>
              </button>
            </div>
          )}
          <div className="absolute bottom-6 right-6 z-30">
            ...
            >
              {uploading && uploadType === "coverImage" ? (
                ...
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:scale-110 transition-transform"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
              )}
            </button>
          </div>
        </>
