  ...
  return (
    <>
      ...
      <div
        ...
        className="crew-item cursor-pointer relative overflow-hidden rounded-2xl group w-full transition-all duration-500 hover:-translate-y-2 shadow-[0_10px_40px_rgba(0,0,0,0.4)] aspect-[4/5]"
      >
        {/* Background Image */}
        <img
          src={member.image}
            ...
            <div className="flex-1 overflow-y-auto p-5 sm:p-8 flex flex-col gap-6">
              ...
              <div className="border-t border-[var(--color-border)]/30 pt-5 flex flex-col gap-3">
                ...
                <div className="flex items-center gap-3">
                  {/* WhatsApp icon */}
                  <span className="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full bg-[#25D366]/10">
                ...
                <div className="flex items-center gap-3">
                  {/* Instagram icon */}
                  <span className="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full bg-[#E1306C]/10">
